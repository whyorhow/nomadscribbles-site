        ...
        <div className="relative pt-2">
            ...
            <main className="px-2 py-2 max-w-screen-xl mx-auto space-y-12 flex flex-col items-center pb-24">
                ...
                <div className="w-full flex flex-col items-center justify-center gap-6 mt-20 mb-12 relative z-10">
                    ...
                    <Link to="/brazil/rio" className="flex flex-row items-center justify-center text-[#eeda8d] hover:text-white transition-colors drop-shadow-sm bg-[#ceb752]/20 backdrop-blur-md rounded-full px-8 py-3 border border-[#ceb752]/40 shadow-md hover:bg-[#ceb752]/30 w-fit min-w-[240px]">
