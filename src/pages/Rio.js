...
function Rio() {
    ...
    return (
        <div className="relative min-h-screen pt-2">
            ...
            <section aria-label="Gallery" className="px-2 py-2 max-w-screen-lg mx-auto space-y-6 font-cormorant text-darkText leading-relaxed">
                    ...
                    return (
                        ...
                        >
                            <button
                                ...
                                className="w-10/12 sm:w-3/4 md:w-2/3 lg:w-2/5 max-w-[350px] border-none bg-transparent p-0"
