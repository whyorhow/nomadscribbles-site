    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div className={`absolute bottom-16 left-1/2 -translate-x-1/2 flex flex-row items-end justify-center space-x-3 z-20 transition-all duration-[2000ms] ease-in-out ${showMiniSP ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            <img
      ...
      >
        ...
        >
          ...
          {showMiniSantos && (
            <>
              <img src={process.env.PUBLIC_URL + "/images/Home/Features/SantosMini1.webp"} alt=""
                className="absolute top-2 left-2 w-36 sm:w-48 md:w-64 lg:w-72 z-20 transition-opacity duration-[2000ms]" />
              <img src={process.env.PUBLIC_URL + "/images/Home/Features/SantosMini2.webp"} alt=""
                className="absolute top-1/3 right-4 w-36 sm:w-48 md:w-64 lg:w-72 z-20 transition-opacity duration-[2000ms]" />
              <img src={process.env.PUBLIC_URL + "/images/Home/Features/SantosMini3.webp"} alt=""
      ...
      <div className="w-full max-w-screen-lg mx-auto py-8 relative px-2 sm:px-4">
        ...
        >
          {cards.map((card, idx) => (
            <motion.div
              key={idx}
              className="relative flex-shrink-0 shadow-lg group"
